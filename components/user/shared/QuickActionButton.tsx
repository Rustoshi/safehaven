  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: gradient || color || "linear-gradient(135deg, #3B9EFF 0%, #2563EB 100%)",
          boxShadow: `0 4px 12px ${color ? color + "40" : "rgba(59,158,255,0.3)"}`,
        }}
      >
        {icon}
      </div>

      <span className="max-w-full px-0.5 text-center text-[11px] font-medium leading-tight" style={{ color: "rgba(255,255,255,0.7)" }}>
        {label}
      </span>
